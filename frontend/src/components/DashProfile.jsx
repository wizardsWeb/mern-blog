  ...
  return (
    <>
      ...
      <form className='flex flex-col gap-4'>
        <div className="w-32 h-32 self-center cursor-pointer shadow-md overflow-hiddens rounded-full">
      ...
      <div className="text-red-500 flex justify-between mt-5">
        <span className='cursor-pointor'>Delete Account</span>
        <span className='cursor-pointor'>Sign Out</span>
      </div>
      </div>
    </>
  )
